...
header("Location: sendstuff.php?msg= Mail Sent!");
...
<body bgcolor="#ffffcc">
<h2 align="center">
Fake Email Prank Script By Apex predators
</h2>
<h3 align="center">
Please do not misuse this script. Use it only for hacking.
</h3><br>
<p style="margin-left:15px">
<form action="sendstuff.php" method="POST">
<b>From Name:</b><br>
